...
exports.handler = async function (event) {
  ...
  const systemPrompt = 'Sei un assistente che legge documenti d\'identità italiani (carta d\'identità, tessera sanitaria, foto con documento in mano) da una foto, spesso non perfetta (storta, sfocata, con riflessi). Estrai SOLO i dati che riesci a leggere con sicurezza. Non inventare o dedurre mai un dato che non è chiaramente visibile: se un campo non si legge, lascialo null — questi dati vengono incollati su moduli di registrazione reali, un dato sbagliato è peggio di un campo vuoto. Rispondi SOLO con un oggetto JSON valido, senza testo prima o dopo, con questa forma esatta: {"nome":string|null,"cognome":string|null,"data_nascita":string|null,"indirizzo":string|null,"cap":string|null,"citta":string|null}. "data_nascita" in formato gg/mm/aaaa se presente. "indirizzo" è via/piazza e numero civico, senza città/CAP.';
